    ...
    <div class="flex flex-col justify-center items-center max-w-200 w-100 space-y-3 shadow-sm rounded-sm p-5 bg-white">
        <form method="POST" class="p-8 w-full space-y-5">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" required class="mt-1 p-1 block w-full rounded-sm bg-gray-100 shadow-sm focus:outline-none focus:bg-gray-200">
            </div>
            <div class="mb-4">
                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                <input type="password" name="password" id="password" required class="mt-1 p-1 block w-full rounded-sm bg-gray-100 shadow-sm focus:outline-none focus:bg-gray-200">
            </div>
